...
<?php
/**
 * VERTEX© — Setup complet du cours "Tendinites et Tendinopathies" (VERTEX-TEND)
 *
 * Ce script :
 ...
 *
 * Usage : sudo -u www-data php setup_course_tend.php
 *         (ou depuis Docker : docker exec moodle-local-moodle-1 php /var/www/html/setup_course_tend.php)
 *
 * Prérequis : le cours VERTEX-TEND (id=5) doit exister.
...
$MODULE_FILES = [
    1 => 'CDC_TEND_01_FONDAMENTAUX.md',
    2 => 'CDC_TEND_02_DIAGNOSTIC.md',
    3 => 'CDC_TEND_03_ACHILLE.md',
    4 => 'CDC_TEND_04_COIFFE.md',
    5 => 'CDC_TEND_05_COUDE_GENOU.md',
    6 => 'CDC_TEND_06_POIGNET_BICEPS.md',
    7 => 'CDC_TEND_07_TRAITEMENTS.md',
    8 => 'CDC_TEND_08_PREVENTION_INNOVATIONS.md',
];

// Cas cliniques
$CASE_FILES = [
    ['file' => 'CAS_CLINIQUES_TENDINITES_P1.md', 'name' => 'Cas cliniques Bronze (7 cas)'],
    ['file' => 'CAS_CLINIQUES_TENDINITES_P2.md', 'name' => 'Cas cliniques Argent (6 cas)'],
    ['file' => 'CAS_CLINIQUES_TENDINITES_P3.md', 'name' => 'Cas cliniques Or et Diamant (7 cas)'],
];
...
$SECTIONS = [
    ...
    1  => 'M01 — Fondamentaux',
    2  => 'M02 — Diagnostic',
    3  => 'M03 — Tendon d\'Achille',
    4  => 'M04 — Coiffe des rotateurs',
    5  => 'M05 — Coude et genou',
    6  => 'M06 — Poignet et biceps',
    7  => 'M07 — Traitements',
    8  => 'M08 — Prévention et innovations',
...
$QUIZ_NAMES = [
    1 => 'Quiz M01 — Fondamentaux',
    2 => 'Quiz M02 — Diagnostic',
    3 => 'Quiz M03 — Tendon d\'Achille',
    4 => 'Quiz M04 — Coiffe des rotateurs',
    5 => 'Quiz M05 — Coude et genou',
    6 => 'Quiz M06 — Poignet et biceps',
    7 => 'Quiz M07 — Traitements',
    8 => 'Quiz M08 — Prévention et innovations',
];

$QUIZ_FINAL_NAME = 'Quiz final — Tendinites et Tendinopathies';

$XML_FILE = $CONTENT_DIR . '/quiz_tendinites.xml';
...
echo "\n";
echo "  ═══════════════════════════════════════════════════════════════\n";
echo "  VERTEX© — Setup cours Tendinites et Tendinopathies (VERTEX-TEND)\n";
echo "  ═══════════════════════════════════════════════════════════════\n\n";
...
if (!$course) {
    out("[ERR] Cours VERTEX-TEND (id=$COURSE_ID) introuvable !");
