...
<?php
/**
 * VERTEX© — Setup complet du cours "Hypertension Artérielle" (VERTEX-HTA)
 *
 * Ce script :
 *  1. Nettoie le cours existant (suppression sections > 0 et activités)
 *  2. Crée 14 sections (0-13) avec les bons noms
 *  3. Importe les questions depuis le XML (100 questions)
 ...
 *
 * Usage : sudo -u www-data php setup_course_hta.php
 *         (ou depuis Docker : docker exec moodle-local-moodle-1 php /var/www/html/setup_course_hta.php)
 *
 * Prérequis : le cours VERTEX-HTA (id=8) doit exister.
...
$MODULE_FILES = [
    1  => 'CDC_HTA_01_FONDAMENTAUX.md',
    2  => 'CDC_HTA_02_PHYSIOPATHOLOGIE.md',
    3  => 'CDC_HTA_03_EPIDEMIOLOGIE_DIAGNOSTIC.md',
    4  => 'CDC_HTA_04_BILAN_EXAMENS.md',
    5  => 'CDC_HTA_05_FORMES_CLINIQUES.md',
    6  => 'CDC_HTA_06_COMPLICATIONS.md',
    7  => 'CDC_HTA_07_TRAITEMENT_NON_PHARMACOLOGIQUE.md',
    8  => 'CDC_HTA_08_TRAITEMENT_PHARMACOLOGIQUE.md',
    9  => 'CDC_HTA_09_SITUATIONS_PARTICULIERES.md',
    10 => 'CDC_HTA_10_HTA_SECONDAIRE.md',
    11 => 'CDC_HTA_11_INNOVATIONS_PERSPECTIVES.md',
];

// Cas cliniques
$CASE_FILES = [
    ['file' => 'CAS_CLINIQUES_HTA_P1.md', 'name' => 'Cas cliniques — Partie 1 (7 cas)'],
    ['file' => 'CAS_CLINIQUES_HTA_P2.md', 'name' => 'Cas cliniques — Partie 2 (6 cas)'],
    ['file' => 'CAS_CLINIQUES_HTA_P3.md', 'name' => 'Cas cliniques — Partie 3 (7 cas)'],
    ['file' => 'CAS_CLINIQUES_HTA_P4.md', 'name' => 'Cas cliniques — Partie 4 (8 cas)'],
    ['file' => 'CAS_CLINIQUES_HTA_P5.md', 'name' => 'Cas cliniques — Partie 5 (7 cas)'],
];
...
$SECTIONS = [
    0  => 'Bienvenue',
    1  => 'M01 — Fondamentaux',
    2  => 'M02 — Physiopathologie',
    3  => 'M03 — Épidémiologie et diagnostic',
    4  => 'M04 — Bilan et examens',
    5  => 'M05 — Formes cliniques',
    6  => 'M06 — Complications',
    7  => 'M07 — Traitement non pharmacologique',
    8  => 'M08 — Traitement pharmacologique',
    9  => 'M09 — Situations particulières',
    10 => 'M10 — HTA secondaire',
...
$QUIZ_NAMES = [
    ...
    2  => 'Quiz M02 — Physiopathologie',
    3  => 'Quiz M03 — Épidémiologie et diagnostic',
    4  => 'Quiz M04 — Bilan et examens',
    5  => 'Quiz M05 — Formes cliniques',
    6  => 'Quiz M06 — Complications',
    7  => 'Quiz M07 — Traitement non pharmacologique',
    8  => 'Quiz M08 — Traitement pharmacologique',
    9  => 'Quiz M09 — Situations particulières',
    10 => 'Quiz M10 — HTA secondaire',
    11 => 'Quiz M11 — Innovations et perspectives',
];

$QUIZ_FINAL_NAME = 'Quiz final — Hypertension Artérielle';

$XML_FILE = $CONTENT_DIR . '/quiz_hta.xml';
...
echo "\n";
echo "  ═══════════════════════════════════════════════════════════════\n";
echo "  VERTEX© — Setup cours Hypertension Artérielle (VERTEX-HTA)\n";
echo "  ═══════════════════════════════════════════════════════════════\n\n";
...
if (!$course) {
    out("[ERR] Cours VERTEX-HTA (id=$COURSE_ID) introuvable !");
...
echo "\n";
out("[*] Création des cas cliniques (section 12)...");
...
foreach ($CASE_FILES as $cf) {
    ...
    $cm = create_page_activity($course, 12, $cf['name'], $html_content);
    if ($cm) {
...
echo "\n";
out("[*] Création du quiz final (section 13)...");

$quiz_final = create_quiz_activity($course, 13, $QUIZ_FINAL_NAME);
if (!$quiz_final) {
...
echo "  Sections    : " . count($SECTIONS) . " (0-13)\n";
echo "  Pages       : " . (count($MODULE_FILES) + count($CASE_FILES)) . " activités page\n";
echo "  Quiz module : 11 quiz (M01-M11)\n";
