 ...
 *
 * Usage : sudo -u www-data php setup_course_diab.php
 *         (ou depuis Docker : docker exec moodle-local-moodle-1 php /var/www/html/setup_course_diab.php)
 *
 * Prérequis : le cours VERTEX-DIAB (id=7) doit exister.
...
$MODULE_FILES = [
    1  => 'CDC_DIAB_01_FONDAMENTAUX.md',
    2  => 'CDC_DIAB_02_PHYSIOPATHOLOGIE.md',
    3  => 'CDC_DIAB_03_DIAGNOSTIC_DEPISTAGE.md',
    4  => 'CDC_DIAB_04_CLINIQUE_FORMES.md',
    5  => 'CDC_DIAB_05_COMPLICATIONS_MICROVASCULAIRES.md',
    6  => 'CDC_DIAB_06_COMPLICATIONS_MACROVASCULAIRES.md',
    7  => 'CDC_DIAB_07_TRAITEMENT_DT1.md',
    8  => 'CDC_DIAB_08_TRAITEMENT_DT2.md',
    9  => 'CDC_DIAB_09_SITUATIONS_PARTICULIERES.md',
    10 => 'CDC_DIAB_10_INNOVATIONS_RECHERCHE.md',
    11 => 'CDC_DIAB_11_ORGANISATION_EDUCATION.md',
];

// Cas cliniques
$CASE_FILES = [
    ['file' => 'CAS_CLINIQUES_DIABETOLOGIE_P1.md', 'name' => 'Cas cliniques — Partie 1'],
    ['file' => 'CAS_CLINIQUES_DIABETOLOGIE_P2.md', 'name' => 'Cas cliniques — Partie 2'],
    ['file' => 'CAS_CLINIQUES_DIABETOLOGIE_P3.md', 'name' => 'Cas cliniques — Partie 3'],
    ['file' => 'CAS_CLINIQUES_DIABETOLOGIE_P4.md', 'name' => 'Cas cliniques — Partie 4'],
];
...
$SECTIONS = [
    ...
    3  => 'M03 — Diagnostic et dépistage',
    4  => 'M04 — Clinique et formes',
    5  => 'M05 — Complications microvasculaires',
    6  => 'M06 — Complications macrovasculaires',
    7  => 'M07 — Traitement DT1',
    8  => 'M08 — Traitement DT2',
    9  => 'M09 — Situations particulières',
    10 => 'M10 — Innovations et recherche',
    11 => 'M11 — Organisation et éducation',
...
$QUIZ_NAMES = [
    ...
    3  => 'Quiz M03 — Diagnostic et dépistage',
    4  => 'Quiz M04 — Clinique et formes',
    5  => 'Quiz M05 — Complications microvasculaires',
    6  => 'Quiz M06 — Complications macrovasculaires',
    7  => 'Quiz M07 — Traitement DT1',
    8  => 'Quiz M08 — Traitement DT2',
    9  => 'Quiz M09 — Situations particulières',
    10 => 'Quiz M10 — Innovations et recherche',
    11 => 'Quiz M11 — Organisation et éducation',
];

$NUM_MODULES = 11;

$QUIZ_FINAL_NAME = 'Quiz final — Diabétologie';

$XML_FILE = $CONTENT_DIR . '/quiz_diabetologie.xml';
...
echo "\n";
echo "  ═══════════════════════════════════════════════════════════════\n";
echo "  VERTEX© — Setup cours Diabétologie (VERTEX-DIAB)\n";
echo "  ═══════════════════════════════════════════════════════════════\n\n";
...
if (!$course) {
    out("[ERR] Cours VERTEX-DIAB (id=$COURSE_ID) introuvable !");
