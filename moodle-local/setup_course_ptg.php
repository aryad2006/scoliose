...
<?php
/**
 * VERTEX© — Setup complet du cours "Prothèse Totale de Genou" (VERTEX-PTG)
 *
 * Ce script :
 *  1. Nettoie le cours existant (suppression sections > 0 et activités)
 *  2. Crée 10 sections (0-9) avec les bons noms
 *  3. Importe les questions depuis le XML (80 questions)
 *  4. Crée les activités "page" (contenu MD→HTML) dans chaque section
 *  5. Crée les quiz par module (M01-M07) + quiz final
 *  6. Assigne les questions aux quiz par tag Module
 *
 * Usage : sudo -u www-data php setup_course_ptg.php
 *         (ou depuis Docker : docker exec moodle-local-moodle-1 php /var/www/html/setup_course_ptg.php)
 *
 * Prérequis : le cours VERTEX-PTG (id=3) doit exister.
...
$MODULE_FILES = [
    1 => 'CDC_PTG_01_FONDAMENTAUX.md',
    2 => 'CDC_PTG_02_PATHOLOGIES_INDICATIONS.md',
    3 => 'CDC_PTG_03_IMPLANTS_CONCEPTION.md',
    4 => 'CDC_PTG_04_PLANIFICATION_CHIRURGIE.md',
    5 => 'CDC_PTG_05_RESULTATS_COMPLICATIONS.md',
    6 => 'CDC_PTG_06_REPRISES_CAS_COMPLEXES.md',
    7 => 'CDC_PTG_07_REEDUCATION_INNOVATIONS.md',
];

// Cas cliniques
$CASE_FILES = [
    ['file' => 'CAS_CLINIQUES_PTG.md', 'name' => 'Cas cliniques — Prothèse Totale de Genou'],
];
...
$SECTIONS = [
    0 => 'Bienvenue',
    1 => 'M01 — Fondamentaux',
    2 => 'M02 — Pathologies et indications',
    3 => 'M03 — Implants et conception',
    4 => 'M04 — Planification chirurgicale',
    5 => 'M05 — Résultats et complications',
    6 => 'M06 — Reprises et cas complexes',
    7 => 'M07 — Rééducation et innovations',
    8 => 'Cas cliniques progressifs',
    9 => 'Quiz final — Évaluation complète',
];

// Noms des quiz par module
$QUIZ_NAMES = [
    1 => 'Quiz M01 — Fondamentaux',
    2 => 'Quiz M02 — Pathologies et indications',
    3 => 'Quiz M03 — Implants et conception',
    4 => 'Quiz M04 — Planification chirurgicale',
    5 => 'Quiz M05 — Résultats et complications',
    6 => 'Quiz M06 — Reprises et cas complexes',
    7 => 'Quiz M07 — Rééducation et innovations',
];

$QUIZ_FINAL_NAME = 'Quiz final — Prothèse Totale de Genou';

$XML_FILE = $CONTENT_DIR . '/quiz_ptg.xml';
 ...
 * Retourne le numéro du module (1-7) ou 0 si non trouvé.
 */
...
echo "\n";
echo "  ═══════════════════════════════════════════════════════════════\n";
echo "  VERTEX© — Setup cours Prothèse Totale de Genou (VERTEX-PTG)\n";
echo "  ═══════════════════════════════════════════════════════════════\n\n";
...
if (!$course) {
    out("[ERR] Cours VERTEX-PTG (id=$COURSE_ID) introuvable !");
...
// ── 7. Créer les activités Page (modules 1-7) ──
echo "\n";
out("[*] Création des pages de contenu (M01-M07)...");
...
// ── 8. Créer les quiz par module (M01-M07) ──
echo "\n";
...
// ── 9. Créer les pages de cas cliniques (section 8) ──
echo "\n";
out("[*] Création des cas cliniques (section 8)...");
...
foreach ($CASE_FILES as $cf) {
    ...
    $cm = create_page_activity($course, 8, $cf['name'], $html_content);
    if ($cm) {
...
// ── 10. Créer le quiz final (section 9) ──
echo "\n";
out("[*] Création du quiz final (section 9)...");

$quiz_final = create_quiz_activity($course, 9, $QUIZ_FINAL_NAME);
if (!$quiz_final) {
...
echo "  Sections    : " . count($SECTIONS) . " (0-9)\n";
echo "  Pages       : " . (count($MODULE_FILES) + count($CASE_FILES)) . " activités page\n";
echo "  Quiz module : 7 quiz (M01-M07)\n";
