...
<?php
/**
 * VERTEX© — Setup complet du cours "Chirurgie du Rachis et Scoliose" (VERTEX-SCOLIOSE)
 *
 * Ce script :
 *  1. Nettoie le cours existant (suppression sections > 0 et activités)
 *  2. Crée 28 sections (0-27) avec les bons noms
 *  3. Importe les questions depuis le XML (80 questions)
 *  4. Crée les activités "page" (contenu MD→HTML) dans chaque section
 *  5. Crée les quiz par module (M01-M25) + quiz final
 *  6. Assigne les questions aux quiz par tag Module
 *
 * Usage : sudo -u www-data php setup_course_scol.php
 *         (ou depuis Docker : docker exec moodle-local-moodle-1 php /var/www/html/setup_course_scol.php)
 *
 * Prérequis : le cours VERTEX-SCOLIOSE (id=2) doit exister.
...
$COURSE_ID       = 2;
$COURSE_SHORTNAME = 'VERTEX-SCOLIOSE';
...
$MODULE_FILES = [
    1  => 'MODULE_01_ANATOMIE_RACHIS.md',
    2  => 'MODULE_02_EMBRYOLOGIE_CROISSANCE.md',
    3  => 'MODULE_03_BIOMECANIQUE.md',
    4  => 'MODULE_04_DEFINITIONS_EPIDEMIOLOGIE.md',
    5  => 'MODULE_05_CLASSIFICATION.md',
    6  => 'MODULE_06_EXAMEN_CLINIQUE.md',
    7  => 'MODULE_07_IMAGERIE.md',
    8  => 'MODULE_08_SIA.md',
    9  => 'MODULE_09_EOS_INFANTILE_JUVENILE.md',
    10 => 'MODULE_10_SCOLIOSE_ADULTE.md',
    11 => 'MODULE_11_SCOLIOSE_CONGENITALE.md',
    12 => 'MODULE_12_NEUROMUSCULAIRE.md',
    13 => 'MODULE_13_SYNDROMIQUE.md',
    14 => 'MODULE_14_CYPHOSE_SAGITTAL.md',
    15 => 'MODULE_15_INSTRUMENTATION.md',
    16 => 'MODULE_16_VOIES_ABORD.md',
    17 => 'MODULE_17_COMPLICATIONS.md',
    18 => 'MODULE_18_REEDUCATION.md',
    19 => 'MODULE_19_HERNIE_DISCALE.md',
    20 => 'MODULE_20_STENOSE_CANALAIRE.md',
    21 => 'MODULE_21_SPONDYLOLISTHESIS.md',
    22 => 'MODULE_22_INFECTIONS.md',
    23 => 'MODULE_23_TRAUMATISMES.md',
    24 => 'MODULE_24_TUMEURS.md',
    25 => 'MODULE_25_OSTEOPOROSE.md',
];

// Cas cliniques
$CASE_FILES = [
    ['file' => 'CAS_CLINIQUES_SCOLIOSE.md', 'name' => 'Cas cliniques progressifs (20 cas)'],
];

// Noms des sections
$SECTIONS = [
    0  => 'Bienvenue',
    1  => 'M01 — Anatomie du rachis',
    2  => 'M02 — Embryologie et croissance',
    3  => 'M03 — Biomécanique',
    4  => 'M04 — Définitions et épidémiologie',
    5  => 'M05 — Classification',
    6  => 'M06 — Examen clinique',
    7  => 'M07 — Imagerie',
    8  => 'M08 — SIA de l\'adolescent',
    9  => 'M09 — Scoliose infantile',
    10 => 'M10 — Scoliose de l\'adulte',
    11 => 'M11 — Scoliose congénitale',
    12 => 'M12 — Scoliose neuromusculaire',
    13 => 'M13 — Scoliose syndromique',
    14 => 'M14 — Cyphose et plan sagittal',
    15 => 'M15 — Instrumentation',
    16 => 'M16 — Voies d\'abord',
    17 => 'M17 — Complications',
    18 => 'M18 — Rééducation',
    19 => 'M19 — Hernie discale',
    20 => 'M20 — Sténose canalaire',
    21 => 'M21 — Spondylolisthésis',
    22 => 'M22 — Infections du rachis',
    23 => 'M23 — Traumatismes',
    24 => 'M24 — Tumeurs',
    25 => 'M25 — Ostéoporose',
    26 => 'Cas cliniques progressifs',
    27 => 'Quiz final — Évaluation complète',
];

// Noms des quiz par module
$QUIZ_NAMES = [
    1  => 'Quiz M01 — Anatomie du rachis',
    2  => 'Quiz M02 — Embryologie et croissance',
    3  => 'Quiz M03 — Biomécanique',
    4  => 'Quiz M04 — Définitions et épidémiologie',
    5  => 'Quiz M05 — Classification',
    6  => 'Quiz M06 — Examen clinique',
    7  => 'Quiz M07 — Imagerie',
    8  => 'Quiz M08 — SIA de l\'adolescent',
    9  => 'Quiz M09 — Scoliose infantile',
    10 => 'Quiz M10 — Scoliose de l\'adulte',
    11 => 'Quiz M11 — Scoliose congénitale',
    12 => 'Quiz M12 — Scoliose neuromusculaire',
    13 => 'Quiz M13 — Scoliose syndromique',
    14 => 'Quiz M14 — Cyphose et plan sagittal',
    15 => 'Quiz M15 — Instrumentation',
    16 => 'Quiz M16 — Voies d\'abord',
    17 => 'Quiz M17 — Complications',
    18 => 'Quiz M18 — Rééducation',
    19 => 'Quiz M19 — Hernie discale',
    20 => 'Quiz M20 — Sténose canalaire',
    21 => 'Quiz M21 — Spondylolisthésis',
    22 => 'Quiz M22 — Infections du rachis',
    23 => 'Quiz M23 — Traumatismes',
    24 => 'Quiz M24 — Tumeurs',
    25 => 'Quiz M25 — Ostéoporose',
];

$QUIZ_FINAL_NAME = 'Quiz final — Chirurgie du Rachis et Scoliose';

$XML_FILE = $CONTENT_DIR . '/quiz_scoliose.xml';
...
/**
 * Extrait le premier tag Module (MXX) du texte d'une question.
 * Retourne le numéro du module (1-25) ou 0 si non trouvé.
 */
...
echo "\n";
echo "  ═══════════════════════════════════════════════════════════════\n";
echo "  VERTEX© — Setup cours Chirurgie du Rachis et Scoliose\n";
echo "  ═══════════════════════════════════════════════════════════════\n\n";
...
if (!$course) {
    out("[ERR] Cours VERTEX-SCOLIOSE (id=$COURSE_ID) introuvable !");
...
// Classer les questions par module (premier tag MXX trouvé)
$questions_by_module = [];
for ($i = 1; $i <= 25; $i++) {
...
// ── 7. Créer les activités Page (modules 1-25) ──
echo "\n";
out("[*] Création des pages de contenu (M01-M25)...");
...
// ── 8. Créer les quiz par module (M01-M25) ──
echo "\n";
...
// ── 9. Créer les pages de cas cliniques (section 26) ──
echo "\n";
out("[*] Création des cas cliniques (section 26)...");
...
foreach ($CASE_FILES as $cf) {
    ...
    $cm = create_page_activity($course, 26, $cf['name'], $html_content);
    if ($cm) {
...
// ── 10. Créer le quiz final (section 27) ──
echo "\n";
out("[*] Création du quiz final (section 27)...");

$quiz_final = create_quiz_activity($course, 27, $QUIZ_FINAL_NAME);
if (!$quiz_final) {
...
echo "  Sections    : " . count($SECTIONS) . " (0-27)\n";
echo "  Pages       : " . (count($MODULE_FILES) + count($CASE_FILES)) . " activités page\n";
echo "  Quiz module : 25 quiz (M01-M25)\n";
