...
<?php
/**
 * VERTEX© — Setup complet du cours "Hyperthyroïdie" (VERTEX-HYPER)
 *
 * Ce script :
 *  1. Nettoie le cours existant (suppression sections > 0 et activités)
 *  2. Crée 14 sections (0-13) avec les bons noms
 *  3. Importe les questions depuis le XML (96 questions)
 ...
 *
 * Usage : sudo -u www-data php setup_course_hyper.php
 *         (ou depuis Docker : docker exec moodle-local-moodle-1 php /var/www/html/setup_course_hyper.php)
 *
 * Prérequis : le cours VERTEX-HYPER (id=10) doit exister.
...
$MODULE_FILES = [
    1  => 'CDC_HYPER_01_EMBRYOLOGIE_ANATOMIE.md',
    2  => 'CDC_HYPER_02_PHYSIOLOGIE.md',
    3  => 'CDC_HYPER_03_PHYSIOPATHOLOGIE_ETIOLOGIES.md',
    4  => 'CDC_HYPER_04_CLINIQUE.md',
    5  => 'CDC_HYPER_05_PARACLINIQUE.md',
    6  => 'CDC_HYPER_06_FORMES_CLINIQUES.md',
    7  => 'CDC_HYPER_07_DIAGNOSTIC_DEPISTAGE.md',
    8  => 'CDC_HYPER_08_TRAITEMENT_ATS.md',
    9  => 'CDC_HYPER_09_RAI_CHIRURGIE.md',
    10 => 'CDC_HYPER_10_IATROGENES_SECONDAIRES.md',
    11 => 'CDC_HYPER_11_INNOVATIONS_PERSPECTIVES.md',
];

// Cas cliniques
$CASE_FILES = [
    ['file' => 'CAS_CLINIQUES_HYPER_P1.md', 'name' => 'Cas cliniques — Partie 1'],
    ['file' => 'CAS_CLINIQUES_HYPER_P2.md', 'name' => 'Cas cliniques — Partie 2'],
    ['file' => 'CAS_CLINIQUES_HYPER_P3.md', 'name' => 'Cas cliniques — Partie 3'],
];
...
$SECTIONS = [
    ...
    8  => 'M08 — Traitement ATS',
    9  => 'M09 — RAI et chirurgie',
    10 => 'M10 — Iatrogènes et secondaires',
...
$QUIZ_NAMES = [
    ...
    8  => 'Quiz M08 — Traitement ATS',
    9  => 'Quiz M09 — RAI et chirurgie',
    10 => 'Quiz M10 — Iatrogènes et secondaires',
    11 => 'Quiz M11 — Innovations et perspectives',
];

$NUM_MODULES = 11;

$QUIZ_FINAL_NAME = 'Quiz final — Hyperthyroïdie';

$XML_FILE = $CONTENT_DIR . '/quiz_hyperthyroidie.xml';
...
echo "\n";
echo "  ═══════════════════════════════════════════════════════════════\n";
echo "  VERTEX© — Setup cours Hyperthyroïdie (VERTEX-HYPER)\n";
echo "  ═══════════════════════════════════════════════════════════════\n\n";
...
if (!$course) {
    out("[ERR] Cours VERTEX-HYPER (id=$COURSE_ID) introuvable !");
